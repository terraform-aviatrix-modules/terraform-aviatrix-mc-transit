...
# Consistency Check Skill — terraform-aviatrix-mc-transit
...
`https://github.com/terraform-aviatrix-modules/terraform-aviatrix-mc-transit/blob/main/img/azure.png?raw=true`
